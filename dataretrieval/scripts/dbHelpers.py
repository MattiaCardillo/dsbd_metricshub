...
queries = {
    ...
    "createView": """
        ...
        metrics1h.other_details as other_details,
        ...
        FROM metrics1h
        JOIN metrics3h
        ON metrics1h.metric = metrics3h.metric AND metrics1h.other_details = metrics3h.other_details 
        JOIN metrics12h
        ON metrics1h.metric = metrics12h.metric AND metrics1h.other_details = metrics12h.other_details 
    """,
    "getMetricsByName": "SELECT * from allmetricviewfinal WHERE name = %s",
    "listAllNames": "SELECT name, other_details from allmetricviewfinal",
